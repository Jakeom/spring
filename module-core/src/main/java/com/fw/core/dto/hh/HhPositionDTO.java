...
@AllArgsConstructor
public class HhPositionDTO extends CommonDTO {
    ...
    private String progressStepNm;
    private String resumeFileId;
    private String agreeFileId;
    private String resumeModifyFlag;
    private boolean isTemp;       		    // 임시회원여부

    private List<FileDTO> resumeFileList;
