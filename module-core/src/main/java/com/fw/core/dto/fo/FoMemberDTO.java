...
@AllArgsConstructor
@NoArgsConstructor
public class FoMemberDTO extends CommonDTO {
    ...
    private String hhCommFlag;              // [헤드헌터] 헤드헌터 커뮤니티 알림여부
    private String hhApFlag;                // [헤드헌터] 헤드헌터 맞춤인재 알림여부
