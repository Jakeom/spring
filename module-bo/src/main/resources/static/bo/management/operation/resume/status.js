...
function loadTable() {
    ...
    let params = {
        ...
        phoneOption: phone,
        emailOption: email,
        createMemberDtype: $('#divisionSelect').val()
    };
    ...
    if(start > end) {
        ...
        $("#datatable").DataTable({
            ...
            ajax: {
                type: "get",
                url:"/bo/management/operation/resume/status/list",
                data: params,
            ...
            columns: [
                ...
                {"data": "resumeName", "defaultContent": "-"},
                {"data": "createMemberDtype", "defaultContent": "-"},
                {"data": "createdAt"},
                {"data": "createPath", "defaultContent": "-"},
                {
                    "data" : "id",
                    "render" : function(data){
                        return "<a style='font-weight: bold;' href='/bo/management/operation/resume/status/" + data + "'>" + "이력서보기" + "</a>";
                    }
                },
                {"render": function (){
                        return '-'
