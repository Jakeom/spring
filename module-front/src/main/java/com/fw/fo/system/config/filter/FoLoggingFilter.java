package com.fw.fo.system.config.filter;
...
@WebFilter(urlPatterns = "/fo/*")
public class FoLoggingFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		TbApiLog apiLog = TbApiLogRequestDto.builder().createDt(LocalDateTime.now()).accessIp(IpUtil.getClientIp())
