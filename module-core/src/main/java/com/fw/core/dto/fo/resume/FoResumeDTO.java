package com.fw.core.dto.fo.resume;
...
@AllArgsConstructor
@NoArgsConstructor
public class FoResumeDTO extends CommonDTO {
    ...
    private String employmentStatusCd;          // 취업상태코드 참조
    private String existTemp;                   // 임시저장테이블 존재여부
    ...
    private String parentResumeId;              // 임시저장 이력서인 경우 부모이력서 id
    private String pictureFileId;               // 통합파일 관리 일련번호
    private String createPath;                  // 등록내용
    private String firstOpenChanged;            // 최초공개/비공개 변경 여부
    private String delFlag;                     // 삭제여부
    private String f;                     // 삭제여부

    //hh_resume_reading_history
    private String expireFlag;                  // 이력서 열람 만료여부
    private String expireAt;                    // 이력서 열람 만료기간
    private String registerPathCd;              // 등록경로
    ...
    private MultipartFile[] agreeResumeFile;
    private MultipartFile[] enResumeFile;
    private MultipartFile[] portFolioFiles;

    private List<FoResumeDTO> portfolioList;
    private List<FoResumeDTO> careerList;
    private List<FoResumeDTO> academicBackgroundList;
    private List<FoResumeDTO> academicBackgroundMajorList;
    private List<FoResumeDTO> specList;
    ...
    private String hhReferralCode;
    private String mode;
    private String applicantId;
    private String applicantUpDt;
    private String degreeNm;
    private String languageId;
    private String licenseId;
    private String awardId;
    private String contentId;
    private String findingJob;
