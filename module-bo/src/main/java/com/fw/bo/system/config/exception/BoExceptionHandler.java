...
public class BoExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(BoBizException.class)
    protected ResponseEntity<ResponseVO> handleCustomException(BoBizException e){
        request.setAttribute("error", e);
