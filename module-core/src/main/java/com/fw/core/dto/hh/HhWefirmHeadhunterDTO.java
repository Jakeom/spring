...
@NoArgsConstructor
@AllArgsConstructor
public class HhWefirmHeadhunterDTO extends CommonDTO implements Serializable {

    private String id;                  // we펌 일련번호
    private String createdAt;		    // 생성일시
    private String updatedAt;           // 수정일시
    private String ceoMemberId;         // we펌 대표자 일련번호
