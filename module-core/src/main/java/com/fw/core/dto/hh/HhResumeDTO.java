...
@AllArgsConstructor
@NoArgsConstructor
public class HhResumeDTO extends CommonDTO {
    ...
    private List<HhResumeDTO> portfolioList;
    private List<HhResumeDTO> careerList;
    private List<HhResumeDTO> academicBackgroundList;
    private List<HhResumeDTO> academicBackgroundMajorList;
    private List<HhResumeDTO> specList;
